...
static sec_bat_adc_table_data_t temp_table[] = {
	...
	defined(CONFIG_MACH_PICASSO_EUR) || defined(CONFIG_MACH_LT03_EUR)
static sec_bat_adc_table_data_t temp_table[] = {
	{1100,	1140},
	{1000,	1040},
	{900,	940},
...
#define TEMP_HIGH_THRESHOLD_EVENT		567
#define TEMP_HIGH_RECOVERY_EVENT		430
#define TEMP_LOW_THRESHOLD_EVENT		-50
#define TEMP_LOW_RECOVERY_EVENT			0
#define TEMP_HIGH_THRESHOLD_NORMAL	567
#define TEMP_HIGH_RECOVERY_NORMAL		430
#define TEMP_LOW_THRESHOLD_NORMAL		-50
#define TEMP_LOW_RECOVERY_NORMAL		0
#define TEMP_HIGH_THRESHOLD_LPM			567
#define TEMP_HIGH_RECOVERY_LPM			430
#define TEMP_LOW_THRESHOLD_LPM			-50
#define TEMP_LOW_RECOVERY_LPM				0
#else
#define TEMP_HIGH_THRESHOLD_EVENT	600
...
void board_fuelgauge_init(struct sec_fuelgauge_info *fuelgauge)
{
	...
	defined(CONFIG_MACH_PICASSO_LTE) || defined(CONFIG_MACH_MONDRIAN) || defined(CONFIG_MACH_LT03_EUR)
